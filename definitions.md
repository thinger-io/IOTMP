...
In a message field value, `Any`, means that it can store anything. It can be encoded with the default [wire-types](message-structure/message-body.md) supported by IOTMP, or also encoded with the mechanism negotiated in the [Connect](messages/connect.md) message.
